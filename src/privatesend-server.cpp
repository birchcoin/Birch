...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Birch related functionality
...
/*
    ...
    allow endless transaction that would bloat Birch and make it unusable. To
