...
#define BOOST_TEST_MODULE Birch Test Suite

#include "test_birch.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_birch_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
