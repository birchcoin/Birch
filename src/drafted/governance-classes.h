 ...
 *
 *   // network
 *   CBirchNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.birch.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBirchNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BirchNetwork
// //   -- signature requirements : Key1(User)
// class CBirchNetworkVariable : public CGovernanceObject
// {
// private:
