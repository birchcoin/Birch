...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BirchNetwork") type = BirchNetwork;
    if(strType == "BirchNetworkVariable") type = BirchNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BirchNetwork) s = "BirchNetwork";
    if(type == BirchNetworkVariable) s = "BirchNetworkVariable";
