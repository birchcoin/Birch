...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("birch.org", "dnsseed.birch.org"));
        vSeeds.push_back(CDNSSeedData("birchdot.io", "dnsseed.birchdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("birchpay.io", "dnsseed.birchpay.io"));

        // Birch addresses start with 'X'
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("birchdot.io",  "testnet-seed.birchdot.io"));
