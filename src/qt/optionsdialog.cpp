    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BIRCH-light"), QVariant("light"));
    ui->theme->addItem(QString("BIRCH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BIRCH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BIRCH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BIRCH-traditional"), QVariant("trad"));
