    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Birch Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Birch address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and birch: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Birch Core"), this);
    aboutAction->setStatusTip(tr("Show information about Birch Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Birch Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Birch addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Birch addresses"));
    ...
    openAction->setStatusTip(tr("Open a birch: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Birch Core help message to get a list with possible Birch Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Birch Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Birch network", "", count));
    } else {
...
{
    QString strTitle = tr("Birch Core"); // default title
