    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Birch Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Birch Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  birch-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Birch in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BIRCH, 0.1 BIRCH, 1 BIRCH and 10 BIRCH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://birchpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://birchpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Birch Core is shutting down...") + "<br /><br />" +
