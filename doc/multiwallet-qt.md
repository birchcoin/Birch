...
Only requiring some minor changes is birch.cpp.
...
Changes to birch.cpp
----------------------
birch.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
