...
Birch Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 11792.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 11793 for connections and services them.
...
However, in open source software such as Birch Core, where everyone uses
...
pay attention to for reviewers of Birch Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Birch Core uses tinyformat, which is type safe. Leave them out to avoid confusion
