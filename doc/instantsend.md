...
This mechanism has been integrated into Bitcore-Node-Birch which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/birchpay/insight-api-birch#web-socket-api](https://github.com/birchpay/insight-api-birch#web-socket-api)
* API: [https://github.com/birchpay/insight-api-birch#instantsend-transactions](https://github.com/birchpay/insight-api-birch#instantsend-transactions)
...
By default, the Birch Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Birch Core daemon:
